...
- [~] Phase 3.4: Implement network capture -> evidence bridge (IMPLEMENTED on branch phase3.4-network-evidence; codex re-review rounds 5 (7 P1), 6 (4 P2), 7 (3 P2) fixed + regression-tested; pending codex re-review to zero + merge)
