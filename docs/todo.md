...
- [~] Phase 3.4: Implement network capture -> evidence bridge (IMPLEMENTED on branch phase3.4-network-evidence; codex re-review round 5 (7 P1 bridge findings, 2026-06-19) fixed + regression-tested 2026-07-14; pending codex re-review to zero + merge)
