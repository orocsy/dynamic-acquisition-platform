...
- [~] Phase 3.4: Implement network capture -> evidence bridge (IMPLEMENTED on branch phase3.4-network-evidence; codex re-review round 5 (7 P1, 2026-06-19) + round 6 (4 P2, 2026-07-15) fixed + regression-tested; pending codex re-review to zero + merge)
